# Generated by Powerlevel10k configuration wizard on 2020-11-04 at 15:35 IST.
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_LAST_PROMPT_GAP_CHAR != ' ' ]]; then
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_CONTENT_EXPANSION='${P9K_KUBECONTEXT_NAME}/${P9K_KUBECONTEXT_NAMESPACE}' 
